...
const Users: CollectionConfig = {
  ...
  access: {
    // allow ONLY logged-in user to access to /api/users or the equivalent graphQL query
    read: () => true,
    // create, update and delete are allowed by default for authenticated users
  },
